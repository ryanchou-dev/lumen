...
// import images on the current page
...
import positiveEnergy from "../../public/hero/positiveEnergy.jpg";
import glossier from "../../public/hero/glossier.jpg";

// reused component for the past projects section
const ProductCard = ({ title, img, imgalt, body, dir }) => {
	if (dir == "left") {
		return (
			<div className="w-full text-left  xl:flex xl:justify-center items-center">
				<Image
					alt={imgalt}
					src={img}
					className="aspect-square object-cover xl:ml-12 xl:mx-0 mx-auto w-full block max-w-2xl "
				/>
		...
		return (
			<div className="w-full text-left  mt-32 grid xl:flex  xl:justify-center items-center ">
				...
				<Image
					src={img}
					alt={imgalt}
					className=" aspect-square object-cover xl:mr-12 order-first xl:order-none xl:mx-0 mx-auto w-full block max-w-2xl "
				/>
			</div>
		);
	}
...
export default function Home() {
	return (
		<>
			{/* Parallax container for the entire page */}
			<MouseParallaxContainer
			...
			>
				...
				<div className="mb-32 mt-24 text-center lg:text-7xl text-5xl w-full lg:mb-0">
					<div className="text-white mb-6 font-semibold z-50 font-['Jost']">
						<AnimatedText text="Product design that empowers." />
					</div>
							...
							>
								...
								<defs>
									...
									>
										...
										<stop offset="1" stopColor="#70FF00" />
									</linearGradient>
								</defs>
							</svg>
						</div>
					...
					<div className="-ml-6 -mt-32 lg:-mt-48 w-screen overflow-hidden">
						<svg
