...
import ScrollFade from "@/../../src/app/components/ScrollFade";
  ...
  return (
    <>
      <div className="px-8 lg:px-16 xl:px-32 flex   flex-col items-center p-6 bg-[#1A1A1A]">
        ...
        <div className="flex text-center">
          <div className="xl:mt-24 mt-8 lg:text-7xl text-6xl w-full lg:mb-0">
            <div className="max-w-xl text-white mb-6  font-semibold z-50 font-['Jost']">
              <AnimatedTextCharacter text="Product Designer" />
        ...
        <button
          disabled={
            !firstName || !lastName || !phoneNumber || !resumeLink || !address
          }
          onClick={() => submitApplication()}
          className="disabled:bg-black bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
        >
          Submit
        </button>
      </div>
